...
namespace BookingKS.Areas.Admin.Controllers
{
    public class LienHesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,hoTen,sdt,email,ngayGui,noiDung")] LienHe lienHe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,hoTen,sdt,email,ngayGui,noiDung")] LienHe lienHe)
        {
            if (ModelState.IsValid)
            {
