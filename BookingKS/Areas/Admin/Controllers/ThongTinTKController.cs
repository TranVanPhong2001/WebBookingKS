...
{
    public class ThongTinTKController : BaseController
    {
        private HotelContext db = new HotelContext();
        // GET: Admin/ThongTinTK
        ...
        public ActionResult Edit([Bind(Include = "maNV,tenNV,gioiTinh,ngaySinh,diaChi,email,sdt,ImageNV")] NhanVien nhanVien)
        {
            ...
            try
            {
                ...
                var path = Server.MapPath("/Data/" + postedFileName);
                imgNV.SaveAs(path);
            }
            catch { }
            ...
            ViewBag.ngaySinh = nhanVien.ngaySinh;
            return View(nhanVien);
        }
